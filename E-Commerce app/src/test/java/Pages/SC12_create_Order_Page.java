...
//        Select drpCountry = new Select(browser.driver.findElement(country));
//        drpCountry.deselectByValue("1");
...
//        Select drpState = new Select(browser.driver.findElement(state));
//        drpState.deselectByValue("53");
